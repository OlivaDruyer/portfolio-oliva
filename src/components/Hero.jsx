export default function Hero() {
  return (
    <section className="relative px-4 md:px-16 py-8 font-satisfy text-grey-100">
      ...
      <div className="flex flex-col md:flex-row mx-20 items-center text-center justify-between gap-12 md:gap-16">
  ...
  <a
    href="#portfolio"
    className="mt-7 px-6 py-4 text-white font-bold bg-[#e27d6d] rounded-lg shadow-md 
